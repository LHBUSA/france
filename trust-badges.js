  ...
  function mount(){
    ...
    if(!document.getElementById('proptech-trust-badges-css')){
      ...
      style.textContent=`
        ...
        .pt-propdata-icon{position:relative;z-index:1;display:grid;place-items:center;flex:0 0 31px;width:31px;height:31px;border-radius:9px;background:linear-gradient(145deg,#20d7f4,#2577ff 66%,#7357ff)}
